#!/usr/bin/python3
"""
The DBStorage that has private class attribute and public instance methods
"""
...
class DBStorage:
    ...
    def all(self, cls=None):
        """
        query that is on the current database session
        """
        if not cls:
        ...
        def close(self)
        """
        creates a database using remove() in the current database session
        """
